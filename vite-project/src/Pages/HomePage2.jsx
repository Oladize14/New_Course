...
console.log('notes', note)
 ...
 return (
   <div className={"bg-blue-500"}>
    <h1 className='text-blue-200'>Give Feedbacks</h1>
     <button className="btn btn-outline btn-success" onClick={handleGoodClicks}>Good</button>
     <button onClick={handleNeutralClicks}>Neutral</button>
     <button className="btn btn-outline btn-warning" onClick={handleBadClicks}>Bad</button>
     <h2>Statistics</h2>
     <Content
      good={good}
      neutral={neutral}
